...
def critiquing(matrix_Train,
               matrix_Test,
               keyphrase_freq,
               dataset_name,
               model,
               parameters_row,
               critiquing_model_name,
               item_keyphrase_freq=None,
               num_users_sampled=10,
               num_items_sampled=5,
    ...
    columns = [
        'user_id', 'item_id', 'target_rank', 'iteration',
        'critiqued_keyphrase', 'item_rank', 'item_score',
        'num_existing_keyphrases', 'result', 'lambda'
    ]
    ...
    critiquing_model = critiquing_models[critiquing_model_name](
